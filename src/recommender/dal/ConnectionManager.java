 ...
 *
 * <p>ConnectionManager uses the MySQL Connector/J driver to connect to your local MySQL instance.
 *
 * <p>In our example, we will create a DAO (data access object) java class to interact with each
 * MySQL table. The DAO java classes will use ConnectionManager to open and close connections.
 *
 * <p>Instructions: 1. Install MySQL Community Server. During installation, you will need to set up
 * a user, password, and port. Keep track of these values. 2. Download and install Connector/J:
...
public class ConnectionManager {
  ...
  private final String password = "Sampson12@!";
  ...
  private final String schema = "BookRecommender";
